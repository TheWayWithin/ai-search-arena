      ...
      <main className="mx-auto max-w-3xl px-6 py-16">
        ...
        <section className="mt-8 space-y-4 text-base leading-relaxed text-gray-700">
          <p>
            ...
            processes. This page documents the structural safeguards that protect the integrity of
            our benchmark data.
          </p>
        </section>

        <section className="mt-10">
          <h2 className="text-arena-slate text-2xl font-semibold">Ownership</h2>
        ...
        <section className="mt-10">
          <h2 className="text-arena-slate text-2xl font-semibold">Conflict of Interest</h2>
          <p className="mt-4 text-gray-700">
            AI Search Mastery produces tools and content that may be evaluated by this benchmark.
            This creates a structural conflict of interest that we address through the following
            safeguards:
          </p>
          <ul className="mt-4 list-disc space-y-2 pl-6 text-gray-700">
            ...
            <li>
              Evaluation methodology is published, versioned, and locked before each cycle begins.
        ...
        <section className="mt-10">
          <h2 className="text-arena-slate text-2xl font-semibold">Editorial Firewall</h2>
          <div className="mt-4 space-y-3 text-gray-700">
            <p>The benchmark operates under an editorial firewall policy. Specifically:</p>
        ...
        <section className="mt-10">
          <h2 className="text-arena-slate text-2xl font-semibold">Vendor Disclosure Status</h2>
          <p className="mt-4 text-gray-700">
        ...
        <section className="mt-10">
          <h2 className="text-arena-slate text-2xl font-semibold">Corrections Policy</h2>
          <p className="mt-4 text-gray-700">
            Post-publication corrections require dual approval — the person requesting the
            correction and the person approving it must be different. Original scores are preserved
            alongside corrections for full auditability.
          </p>
        </section>

        <section className="mt-10">
          <h2 className="text-arena-slate text-2xl font-semibold">Contact</h2>
          <p className="mt-4 text-gray-700">
