    ...
    <main className="mx-auto max-w-3xl px-6 py-16">
      ...
      <section className="mt-8 space-y-4 text-base leading-relaxed text-gray-700">
        <p>
          ...
          (GEO/AEO) tools against 50+ standardized metrics. Every tool is scored using the same
          methodology, by the same AI models, against the same criteria.
        </p>
        <p>
          ...
          based on vendor marketing, peer anecdotes, and limited trials — leading to wasted budgets,
          poor fits, and high switching costs.
        </p>
      </section>

      <section className="mt-12">
        <h2 className="text-2xl font-semibold text-arena-slate">How It Works</h2>
        <div className="mt-6 space-y-6">
          ...
          <div>
            ...
            <p className="mt-1 text-gray-700">
              ...
              Optimization, Technical Implementation, Analytics, User Experience, and Market Value.
              Every dimension weight is published.
            </p>
          </div>
          <div>
          ...
          <div>
            ...
            <p className="mt-1 text-gray-700">
              Every benchmark cycle produces a sealed audit package containing all evaluation data,
              methodology snapshots, and scoring records with SHA-256 integrity verification.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="mt-12">
        <h2 className="text-2xl font-semibold text-arena-slate">Operator</h2>
